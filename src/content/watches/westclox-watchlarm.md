...
ownersNote:
  ...
  note:
    ...
    - WatchlarmのW5では、2時位置のプッシャーでアラーム時刻を設定し、設定用の追加歯車列と高価な回転ベゼルを省いた。
...
deepDive:
  ...
  - number: "03"
    ...
    paragraphs:
      ...
      - 9時位置にはアラームのON/OFFスライダーがあり、上へ動かすとON、下へ動かすとOFF。ONにすると、ケース側の「ON」刻印が見える。
    citationRefs:
      - 1,2,5,6
      - "1"
      - 1,2
  ...
  - number: "05"
    ...
    paragraphs:
      ...
      - ただし、JunghansがW5のケースを直接製造した、あるいはW5を設計したと断定できる資料は確認できない。Horlbeckも、両者に協力関係または部品供給を通じた近い関係があった可能性として述べている。
    citationRefs:
      - "2"
      - "6"
      - "1"
