...
ownersNote:
  ...
  lead:
    ...
    - 時刻を合わせる動きが、そのままアラーム用ゼンマイの巻上げにもなる。
  guideTitle: 簡易操作ガイド
  guide:
    - ① 時計側の巻き上げ　リューズ通常位置で巻き上げ
    - ② 時刻設定　リューズを引いて時刻を合わせる
    - ③ アラーム設定＋巻き上げ　ベゼルを反時計回りに回し、アラーム時刻を合わせながらアラーム用ゼンマイを巻き上げる
    - ④ 満巻き時の注意　ベゼルが止まったら無理に回さない
  noteTitle: NOTE
  note:
    - Cal.10WAは、Wittnauer最初のアラーム腕時計として記録されている。
    - 時刻機構とアラーム機構は、それぞれ独立した香箱を持つ。
    - 一つのベゼルで、アラーム時刻の設定と巻上げを同時に行う。
    - その一方で、時刻側のベースムーブメントについては資料が食い違っている。
spec:
  era: 1950年代前半
  caseSize: 約36mm（掲載個体）
...
deepDive:
  ...
  - number: "02"
    ...
    paragraphs:
      ...
      - 製造時期は1950年代前半とされ、17石、18,000振動／時、2香箱の手巻きアラームムーブメントを搭載する。
      - 10WAでまず目を引くのは、アラーム側の操作だ。
      - 通常の時刻合わせや時計側の巻上げはリューズで行う。
      - 一方、アラーム時刻を合わせるのは回転ベゼル。
      - ベゼルを反時計回りに回すと、文字盤上のアラーム針が動く。
      - このベゼルは、アラーム時刻を合わせるだけではない。
      - 同じ回転でアラーム用ゼンマイも巻き上げる。
      - つまり10WAでは、**「何時に鳴らすかを決める」ことと「鳴らすための力を蓄える」ことが、一つの操作になっている。**
      - Horlbeckによれば、アラーム側はベゼル約1.5回転で満巻きになり、そこで回転が止まる。
      - 満巻きのまま無理に回すと、伝達輪の歯を傷めるおそれもある。掲載個体でも、この操作系に一度不具合が起きている。
