...
`VA2`には、選択window、生成時刻、Visits / Page views、新旧host内訳、直前期間合計、主要channel、entry page、external/internal flow、SNS着地、国、端末、最大31bucketのtrend、host migration日、freshness markerを含める。IP、Cookie、raw User-Agent、Cloudflare token、Dashboard passwordは含めない。
