...
.range-tools{display:flex;flex-wrap:wrap;gap:8px;align-items:end;margin:0 0 14px}.range-tools label{font-size:10px;letter-spacing:.08em;color:var(--soft)}.range-tools input,.range-tools select,.range-tools button{display:block;margin-top:4px;padding:7px 9px;border:1px solid var(--line);background:var(--paper);color:var(--ink);font:inherit}.range-tools button{cursor:pointer}.bucket-status{font-size:10px;font-weight:700;letter-spacing:.06em}.bucket-status.estimate{color:#8d2c23}.bucket-status.partial{color:#9a7b4f}.bucket-compare{grid-column:1/-1}.bucket-compare td,.bucket-compare th{white-space:nowrap}.bucket-compare .period-cell{white-space:normal;min-width:92px}@media(max-width:760px){.range-tools{display:grid;grid-template-columns:1fr 1fr}.range-tools .bucket-control{grid-column:1/-1}.bucket-compare{overflow:auto}.bucket-compare table{min-width:760px}}
</style>
</head>
<body>
<main>
